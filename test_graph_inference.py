...
model_name = "trained_gnn_NNConv_laplace_only_16.pth" 
#model_name = "trained_gnn_NNConv_v8.pth" 
#model_name = "trained_data_physics_5.pth" 
...
dgl.save_graphs("inference_gnn_laplace_only_VagusA6050_HC0_AS1_16.dgl", [g])
logging.info("Graph saved to inference_gnn_laplace_only_VagusA6050_HC0_AS1_16.dgl")
