...
dgl.save_graphs("inference_gnn_test_dirichlet_VagusA1924_HT60_AS1.dgl", [g])
logging.info("Graph saved to inference_gnn_test_dirichlet_VagusA1924_HT60_AS1.dgl")
