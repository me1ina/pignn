...
model_name = "trained_gnn_NNConv_laplace_v3.pth" 
...
dgl.save_graphs("inference_gnn_test_laplace_Pudendal_Cuff_1_AS10.dgl", [g])
logging.info("Graph saved to inference_gnn_test_laplace_Pudendal_Cuff_1_AS10.dgl")
